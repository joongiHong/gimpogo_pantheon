...
<body>
    ...
    <div id="intro_text">
        <div>
            ...
            <h1 data-aos="fade-left" data-aos-duration="500" data-aos-delay="1200" style="font-size: 3em">탑승을</h1>
            <h1 data-aos="fade-left" data-aos-duration="500" data-aos-delay="1200" style="font-size: 3em;">준비해주세요.</h1>
        </div>
    </div>
    ...
    <div id="main_text" style="text-align: center;">
        ...
        <a href="#" onclick="return chk_form()" class="arrow-btn">탑승수속</a>
    </div>
